...
## Summary
Finished chapter 04 covering many different ways of how data flows through services. The main methods discussed were:
...
So far this book feels like lego blocks with each chapter putting together the foundational pieces that common distributed systems are built upon. I really enjoy this approach because it's too common that we except the norm for what it is without truly understanding the many layers of abstraction we are building upon. 