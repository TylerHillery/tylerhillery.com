...
image: "../../assets/images/DataLakeHouse.svg"
filters:
  - social-share
share:
...
## Conclusion 
Now that we have a blueprint created it's time to start building the data cabin! In my next post I will be writing about my experience on setting up Tabluar with some sample data and running our first queries on our data cabin. 