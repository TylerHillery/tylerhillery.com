...
- **The iPhone storage model**: Applications running on these devices behave more like apps on an iPhone in terms of storage. Backups happen periodically, so data loss between syncs is possible. It's more important that the device can restart and recover into a working state versus being highly available and have persistent storage.
