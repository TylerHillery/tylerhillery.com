...
This blog kicks off a new series I am calling "Tyler Tries" where I write about the topics I am learning about. We are going to kick off the series off with my experience building a real-time data pipeline to visualize Coinbase order book depth
...
Our staging model does some light transformations to get the data into a more usable form.
